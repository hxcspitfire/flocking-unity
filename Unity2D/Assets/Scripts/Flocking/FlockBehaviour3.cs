...
public class FlockBehaviour3 : MonoBehaviour
{
  ...
  public bool UseRandomOnEnemied = true;
  public float RandomWeightOnEnemies = 1.0f;
  public bool UseAlignment = true;
  public float AlignmentWeight = 1.0f;
  public bool UseAlignmentOnEnemies = true;
  public float AlignmentWeightOnEnemies = 1.0f;
  public bool UseCohesion = true;
  public float CohesionWeight = 1.0f;
  public bool UseCohesionOnEnemies = true;
  public float CohesionWeightOnEnemies = 1.0f;
  public bool UseSeparation = true;
  public float SeparationWeight = 1.0f;
  public bool UseSeparationOnEnemies = true;
  public float SeparationWeightOnEnemies = 1.0f;
  public bool UseSeparationWithEnemies = true;
  ...
  public float VisibilityEnemies = 20.0f;
  ...
  void Start()
  {
    ...
    StartCoroutine(Coroutine_Separation(mEnemies, SeparationWeightOnEnemies));
    StartCoroutine(Coroutine_Cohesion(mEnemies, CohesionWeightOnEnemies));
    StartCoroutine(Coroutine_Alignment(mEnemies, AlignmentWeightOnEnemies));
    StartCoroutine(Coroutine_Random(mEnemies, RandomWeightOnEnemies));
  ...
  void Update()
  {
    ...
    {
      mEnemies[i].RotationSpeed = MaxRotationSpeedEnemy;
      mEnemies[i].MaxSpeed = MaxSpeedEnemy;
    }
    HandleInputs();
