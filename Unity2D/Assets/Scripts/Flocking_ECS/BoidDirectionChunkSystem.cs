...
//[BurstCompile]
//public struct BoidDirectionChunkSystem : ISystemBase
//{
...
//    [ReadOnly] public ComponentTypeHandle<BoidDirection> RotationSpeedTypeHandle;
...
//        var boidDirection = chunkRotationSpeeds[i];

//        // Rotate something about its up vector at the speed given by RotationSpeed_IJobChunkStructBased.
//        chunkRotations[i] = new Rotation
//        {
//          Value = quaternion.LookRotation(boidDirection.Direction, math.up())
//        };
//      }
//    }
//  }
...
//    var boidDirection = state.GetComponentTypeHandle<BoidDirection>(true);

//    var job = new RotationSpeedJob()
//    {
//      RotationTypeHandle = rotationType,
//      RotationSpeedTypeHandle = boidDirection,
//      DeltaTime = state.Time.DeltaTime
//    };

//    state.Dependency = job.ScheduleSingle(m_RotationGroup, state.Dependency);
//  }
